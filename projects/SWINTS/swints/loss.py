...
class SetCriterion(nn.Module):
    ...
    def loss_boxes(self, outputs, targets, indices, num_boxes, mask_encoding):
        ...
        # TODO: bug 1
        # handle: pass
        # image_size.shape = [357, 4] 
        # src_boxes.shape = [311, 4]
        
        #   datasets-multi/MLT19/train/imgs/tr_img_04208.jpg
        #   datasets-multi/MLT19/train/imgs/tr_img_07187.jpg
        #   datasets-multi/MLT19/train/imgs/tr_img_07261.jpg
        #   datasets-multi/MLT19/train/imgs/tr_img_04123.jpg
        #   datasets-multi/MLT19/train/imgs/tr_img_07658.jpg
        ...
        #     losses['loss_bbox'] = torch.tensor(0.0).cuda()
        #     losses['corner_case'] = torch.tensor(1.0).cuda()
    ...
    def loss_script_cls(self, outputs, targets, indices, num_boxes, mask_encoding):
        losses = {}
        losses['loss_script_cls'] = outputs['loss_script_cls']
        return losses
    
    def loss_multi_rec(self, outputs, targets, indices, num_boxes, mask_encoding):
        losses = {}
    ...
    def get_loss(self, loss, outputs, targets, indices, num_boxes, mask_encoding, **kwargs):
        ...
        loss_map = {
            ...
            'rec': self.loss_rec,
            'cls': self.loss_script_cls,
            'multi_rec': self.loss_multi_rec,
        }
