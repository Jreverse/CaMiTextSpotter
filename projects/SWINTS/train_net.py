...
from detectron2.evaluation import COCOEvaluator, verify_results, TextEvaluator, TextMultilingualEvaluator
...
#     """
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        if cfg.SEQUENCE.MULTI:
            return TextMultilingualEvaluator(dataset_name, cfg, True, output_folder)
        else:
