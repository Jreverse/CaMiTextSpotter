...
def parse_args():
    ...
    parser.add_argument(
        "--cache_dir",
        default="/mnt/vol/gfsai-east/aml/mobile-vision/gpu/jinghuang/ocr/models/outputs/SPN/detectron2/official/inference/mlt19_val_test/cache_files/",
        help="cache dir",
    )
    ...
    parser.add_argument(
        ...
        default=f"tmp/MLT19/test/intermediate/",
        help="intermediate results, can be dir or zip",
    )

    parser.add_argument(
        "--tmp_dir",
        default="/tmp/detectron2/intermediate/",
    ...
    parser.add_argument("--overlap", default=0.2, type=float, help="IoU threshold for NMS")
    ...
    if args.task == "task1":
        from detectron2.evaluation.mlt19.task1.script import mlt19_eval_task1, rrc_evaluation_funcs

        args.eval_task = mlt19_eval_task1
    elif args.task == "task3":
        from detectron2.evaluation.mlt19.task3.script import mlt19_eval_task3, rrc_evaluation_funcs

        args.eval_task = mlt19_eval_task3

    elif args.task == "task4":
        from detectron2.evaluation.mlt19.task4.script import mlt19_eval_task4, rrc_evaluation_funcs
