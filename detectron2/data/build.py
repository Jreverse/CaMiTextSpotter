...
def build_detection_train_loader(
    dataset, *, mapper, sampler=None, total_batch_size, aspect_ratio_grouping=True, num_workers=0, cfg,
):
    """
    ...
    #     tt1 = dataset[i]
    #     print(tt1['file_name'])
    #     print(tt1['instances'].get('text'))
    #     print(tt1['instances']._nonempty)
    # import ipdb;ipdb.set_trace()
...
def _test_loader_from_config(cfg, dataset_name, mapper=None):
    ...
    if cfg.TEST.SAMPLE>0:
        SAMPLE = min(len(dataset), cfg.TEST.SAMPLE)
        logger.info('Sampling top {} samples for validation'.format(SAMPLE))
